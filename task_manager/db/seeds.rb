...
# Create Users
user1 = User.create!(name: 'Jefff', email: 'jeffff@user.com', password: '1234567', password_reset_token: "token123")
user2 = User.create!(name: 'Ismahann', email: 'ismahann@user.com', password: '1234567', password_reset_token: "123token")
